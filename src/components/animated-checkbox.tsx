...
const AnimatedCheckBox = (props: Props) => {
    ...
    return(
        <Svg viewBox={[-MARGIN, -MARGIN , vWidth + MARGIN, vHeight + MARGIN]} >
            <AnimatedPath d={outlineBoxPath} strokeWidth={2}  strokeLinejoin='round' strokeLinecap="round" animatedProps={animatedBoxProps}/>
            <AnimatedStroke progress={progress} d={checkMarkPath} stroke={checkmarkColor} strokeWidth={5} strokeLinejoin={'round'} strokeLinecap={'round'} strokeOpacity={checked || false ? 1 : 0}/>
        </Svg>
    )
}
